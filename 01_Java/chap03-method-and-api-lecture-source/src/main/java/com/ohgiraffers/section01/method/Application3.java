...
public class Application3 {
    public static void main(String[] args) {
        ...
        다른 메소드간 서로 공유해야 하는 값이 존재하는 경우 메소드 호출 시 하용하는 괄호를 이용해서 값을 전달할 수 있다.
        ...
        //app3.testMethod();  //매개변수는 선언되어 잇지만 인자로 값을 전달하지 않으면 호출 할 수 없다.
        ...
        /* 자동형변환을 이용하여 값을 ㅓ전달할 수 있다. */
        byte byteAge = 10;
        app3.testMethod(byteAge);

        /* 강제형변환을 이용해서 값 전달할 수 있다. */
        long longAge = 80;
