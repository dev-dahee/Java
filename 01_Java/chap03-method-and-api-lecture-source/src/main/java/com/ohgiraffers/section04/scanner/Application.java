...
public class Application {
    public static void main(String[] args) {
        ...
        /*
            ...
            입력받을 때 안내문구는 별도로 출석해주지 않으니 우리가 직접 작성해주어야한다.
            -->자주 하는 혼동상황
        */
        /*
            문자열 입력 받기
        ...
        /*
            ...
            int 범위를 초과한 값을 입렵받게 되면 역시나 InputMismatchException이 발생한다.
         */
        System.out.print("나이를 엽릭하세요 : ");
         ...
         */
        System.out.println("참과 거짓 중 한 가지를 true or false로 입력해주세요. : ");
        ...
        /*
            ...
            그때 사용하는 메소드가 java.lang.String에 있는 charAt(int index)를 사용한다.
